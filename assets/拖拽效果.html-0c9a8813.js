import{_ as n,o as s,c as a,f as t}from"./app-2a9bb723.js";const e={},p=t(`<h1 id="javascript-拖拽效果-动画" tabindex="-1"><a class="header-anchor" href="#javascript-拖拽效果-动画" aria-hidden="true">#</a> JavaScript 拖拽效果-动画</h1><p>鼠标按下 onmousedown，onmousedown 里边鼠标移动 onmousemove，鼠标释放 onmouseup</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">var</span> oDiv <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">getElementById</span><span class="token punctuation">(</span><span class="token string">&#39;box&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
